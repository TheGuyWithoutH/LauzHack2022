...
const TermsAndConditions = () => {
    return (
        <View style={styles.container}>
            ...
            <Text>Last updated: December 03, 2022</Text>
            <Text>Please read these terms and conditions carefully before using Our Service.</Text>
            <Text style={styles.h1}>Interpretation and Definitions</Text>
            ...
            <ul>
                <li>
                    <Text><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named LUO</Text>
                </li>
                <li>
                    <Text><strong>Application Store</strong> means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.</Text>
                </li>
                <li>
                ...
                <li>
                    <Text><strong>Country</strong> refers to:  Switzerland</Text>
                </li>
                <li>
                    <Text><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to LUO.</Text>
                </li>
                <li>
                ...
                <li>
                    <Text><strong>Service</strong> refers to the Application.</Text>
                </li>
                <li>
                    <Text><strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the <a href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank">TermsFeed Terms and Conditions Generator</a>.</Text>
                </li>
                <li>
            ...
            <Text style={styles.h1}>Links to Other Websites</Text>
            ...
            <Text style={styles.h1}>Termination</Text>
            ...
            <Text style={styles.h1}>Limitation of Liability</Text>
            ...
            <Text style={styles.h1}>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</Text>
            ...
            <Text style={styles.h1}>Governing Law</Text>
            ...
            <Text style={styles.h1}>Disputes Resolution</Text>
            ...
            <Text style={styles.h1}>For European Union (EU) Users</Text>
            ...
            <Text style={styles.h1}>United States Legal Compliance</Text>
            ...
            <Text style={styles.h1}>Severability and Waiver</Text>
            <h2>Severability</h2>
            ...
            <Text style={styles.h1}>Translation Interpretation</Text>
            ...
            <Text style={styles.h1}>Changes to These Terms and Conditions</Text>
            ...
            <ul>
                <li>By visiting this page on our website: <a href="www.google.ch" rel="external nofollow noopener" target="_blank">www.google.ch</a></li>
            </ul>
        </View>
    );
};
